...
# Usage: ./pure_sft.sh <dataset_name> <gpu_id> [models]
# Example: ./pure_sft.sh Amazon_All_Beauty 0
# Example: ./pure_sft.sh Amazon_All_Beauty 0 "SASRec ItemKNN LightGCN"

if [ -z "$1" ] || [ -z "$2" ]; then
    echo "Usage: $0 <dataset_name> <gpu_id> [models]"
    echo "Example: $0 Amazon_All_Beauty 0"
    echo "Example: $0 Amazon_All_Beauty 0 \"SASRec ItemKNN LightGCN\""
    exit 1
fi
...
# echo "================================================"
# echo "Training pure SFT model (not autoregressive)..."
# echo "================================================"
# python GRPO/models/main_pure.py \
#     --dataset $1 \
#     --data_path dataset \
